<template>
  <div class="flex justify-center relative mx-auto h-[510px] container overflow-hidden">
    <div
      class="sliding-logos-illustration is-animated absolute bottom-0 right-[0px] z-[-1]"
