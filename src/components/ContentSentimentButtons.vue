...
<template>
    <div class="sentiment-buttons" @click.stop>
        <relewise-content-sentiment-buttons
            ...
            :user.prop="user"
        />
        <div v-else class="sentiment-buttons__fallback" role="group" aria-label="Content sentiment actions" aria-disabled="true">
            <button type="button" class="sentiment-buttons__button" disabled>
                <svg
                ...
                <span class="sr-only">Log in to like</span>
            </button>
            <button type="button" class="sentiment-buttons__button" disabled>
                <svg
                    class="sentiment-buttons__icon"
                ...
                <span class="sr-only">Log in to dislike</span>
            </button>
        </div>
    </div>
</template>
