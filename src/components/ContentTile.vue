...
<template>
    <RouterLink  v-if="contextStore.getshowContentMenu()" :to="{ name: 'content', params: { id: content.contentId } }"
     ...
     <RouterLink v-else :to="{ name: 'content', params: { id: content.contentId } }"
                class="relative flex flex-col overflow-hidden bg-white text-slate-900 hover:!text-brand-500 transition duration-200">
