...
const details = computed(() => {
    ...
    const productDetails = Object.entries(product.value.data ?? {})
        .filter((x) => 
            ...
            ['Margin', 'ImportedAt', 'Serie', 'FeedIntegrationVersion', 'InStock', 'OnSale', 'AvailableInChannels', 'AvailableInMarkets', 'articleNumber', 'StockLevel', 'Afdichting', 'Afdichtoppervlak', 'Afmeting', 'a-maat', 'Boring', 'Brandgedrag', 'Brandwerend', 'Breedte (mm)', 'Calc Lev Datum', 'Class.', 'Connectie Norm', 'Dikte (mm)', 'Draad', 'Draadaansluiting', 'Drukbereik', 'Fixing Connection', 'Foodgrade', 'Functie', 'Gerecycled', 'Gewicht per stuk (kg)', 'Graden', 'Hoogte (mm)', 'Kleur', 'Kleurcode', 'Kleureffect', 'Kleurfamilie', 'Lang', 'Led geschikt', 'Lengte (m)', 'Lengte (mm)', 'Levertype', 'Masking', 'Mat.²', 'Materiaal', 'Materiaalgroep', 'Meetbereik', 'Merk', 'Naam', 'Normering', 'Diameter (Ø)', 'Diameter (Ø inw.)', 'Diameter (Ø uitw.)', 'Diameter (Ø²)', 'Diameter (Ø³)', 'Diameter (Ø4)', 'Opbrengst', 'Oppervlakte', 'Plaatdikte', 'Producentnr', 'Productiemethode', 'Productsoort', 'Productvorm', 'Programma', 'Radius', 'Recyclebaar met ReVink', 'Tekening Nummer', 'Toepassing', 'Tolerancies', 'Type', 'Verbinding', 'Verbinding 2', 'Verbinding 3', 'Verbinding 4', 'Vermogen', 'Voltage', 'Volume', 'Voorraadartikel (D1)', 'Vorm', 'Wanddikte'].includes(x[0])); //add fields here to show on PDP
