        ...
        <div v-if="content" class="mb-16">
            ...
            <div class="flex flex-wrap xl:flex-nowrap gap-8 xl:gap-20 mt-3">
                ...
                <div class="bg-white flex-grow">
                    <div>
                        <!-- <div v-if="content.displayName">
                            <span class="text-slate-600 mb-4 text-lg">{{ content.displayName }}</span>
                        </div> -->
...
import { ContentSearchBuilder, ProductSearchBuilder, SimilarProductsProductBuilder, type CategoryNameAndIdResult, type ContentResult, type ContentResultDetails, type ProductRecommendationResponse, type ProductResult } from '@relewise/client';
